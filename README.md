...
LornaMenu is based off [YimMenu] (https://github.com/YimMenu/YimMenu) which is based off [BigBaseV2](https://github.com/Pocakking/BigBaseV2) which was an amazing base at the time but nowadays is a bit dated.
So here I am with an up-to-date menu focusing on protecting the user from toxic modders.

## TABLE OF CONTENTS: (LINKS BELOW THIS ARE BROKEN)
------------------------------------------------------------------------------------------------------------

 * [How to build](#how-to-build)
 * [Make your own flavour of LornaMenu](#make-your-own-flavour-of-lornamenu)
